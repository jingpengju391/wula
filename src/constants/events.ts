...
export const SIGNALINGINVITE = "SIGNALINGINVITE"
export const GETRTCINVITEIDS = "GETRTCINVITEIDS"
export const INSERTTOCURCVE = "INSERTTOCURCVE"
export const CLOSERIGHTDRAWER = "CLOSERIGHTDRAWER"
export const SHOWPLAYERMODAL = "SHOWPLAYERMODAL"
